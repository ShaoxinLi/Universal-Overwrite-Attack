...
from src.attacks.uoa import UOA, ScalarTracker, TensorBoardImageLogger, TensorBoardHparamsLogger, \
...
if __name__ == "__main__":
    ...
    args.exp_type = f"uoa_attack_{args.watermarking_model}"
    setup_cfg(args)
    log_cfg(args)
    ...
    attacker = UOA(device=args.device, seed=args.seed)
    ...
    attacker.train(
        decoder=args.model, loader=args.train_loader, img_size=args.img_size,
    ...
    attacker.test(
        decoder=args.decoder, loader=args.test_loader, xi=args.xi,
