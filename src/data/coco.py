...
def coco(dataset_dir_path, part, img_size, message_length):
    ...
    if not os.path.exists(dir_path):
        dir_path = os.path.join("./Datasets/coco10k", part)
    ...
    if part == "train" or part == "test":
        ...
        if not os.path.exists(message_path):
            message_path = os.path.join("./Datasets/coco10k", part, "watermarks.npy")
