...
def imagenet(dataset_dir_path, part, img_size, message_length):

    assert part in ["victim", "train", "test"]
    if part != "test":
    ...
    if not os.path.exists(dir_path):
        dir_path = os.path.join("./Datasets/imagenet10k", part)
    ...
    if part == "train" or part == "test":
        ...
        if not os.path.exists(message_path):
            message_path = os.path.join("./Datasets/imagenet10k", part, "watermarks.npy")
